...
"""
more at : https://github.com/langchain-ai/langgraph/blob/main/examples/rag/langgraph_adaptive_rag.ipynb
"""
...
The vectorstore contains documents related to mental health.
...
#     )
# )
# print(question_router.invoke({"question": "Jelaskan mengenai PTSD?"}))
...
# }
# for output in app.stream(inputs, {"recursion_limit": 6}):
...
# # Run
# inputs = {
#     "question": "pengaruh metamfetamin pada kesehatan"
# }
# for output in app.stream(inputs, {"recursion_limit": 6}):
#     for key, value in output.items():
#         # Node
...
# Run
inputs = {
    "question": "Hello, my name is Roy. What is your name?"
}
for output in app.stream(inputs, {"recursion_limit": 6}):
    for key, value in output.items():
        # Node
